...
alias doom='chocolate-doom -iwad ~/m/IWADs/DOOM/DOOM.WAD'
alias alientc='chocolate-doom -iwad ~/m/IWADs/DOOM/DOOM.WAD -deh ~/m/IWADs/DOOM/ALIENTC/ATCUD19.DEH -merge ~/m/IWADs/DOOM/ALIENTC/ALITCSF.WAD -file ~/m/IWADs/DOOM/ALIENTC/ALITCSND.WAD ~/m/IWADs/DOOM/ALIENTC/ALITCWAD.WAD'
alias doomlep='chocolate-doom -iwad ~/m/IWADs/DOOM/DOOM.WAD -file ~/m/IWADs/DOOM/DOOMLEP/JPTR_V40.WAD'
alias uac_dead='chocolate-doom -iwad ~/m/IWADs/DOOM/DOOM.WAD -file ~/m/IWADs/DOOM/UAC_DEAD/UAC_DEAD.WAD -gameversion 1.9 -warp 1 8'
alias doom2='chocolate-doom -iwad ~/m/IWADs/DOOM2/DOOM2.WAD'
alias uacultra='prboom -iwad ~/m/IWADs/DOOM2/DOOM2.WAD -file ~/m/IWADs/DOOM2/UACULTRA/UACULTRA.WAD'
alias plutonia='chocolate-doom -iwad ~/m/IWADs/PLUTONIA/PLUTONIA.WAD'
alias tnt='chocolate-doom -iwad ~/m/IWADs/TNT/TNT.WAD'
alias hexen='chocolate-hexen -iwad ~/m/IWADs/HEXEN/HEXEN.WAD'
alias heretic='chocolate-heretic -iwad ~/m/IWADs/HERETIC/HERETIC.WAD'
