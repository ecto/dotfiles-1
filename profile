...
alias plutonia='chocolate-doom -nomusic -iwad ~/m/IWADs/PLUTONIA/PLUTONIA.WAD'
alias tnt='chocolate-doom -nomusic -iwad ~/m/IWADs/TNT/TNT.WAD'
alias hexen='chocolate-hexen -nomusic -iwad ~/m/IWADs/HEXEN/HEXEN.WAD'
alias heretic='chocolate-heretic -nomusic -iwad ~/m/IWADs/HERETIC/HERETIC.WAD'
